      ...
      <?php echo form_open_multipart(base_url()."adm/m_soal/simpan", "class='form-horizontal'"); ?>
          ...
          <div id="konfirmasi"></div>
            ...
            <div class="form-group fgsoal">
              ...
              <div class="col-md-10"><?php echo form_dropdown('id_mapel', $p_mapel, $d['id_mapel'], 'class="form-control" id="id_mapel" required onchange="m_kel_soal_mapel(this.value)"'); ?></div>
            </div>
			<div class="form-group fgsoal">
              <div class="col-md-2"><label>Kelompok Soal</label></div>
              <div class="col-md-10"><?php echo form_dropdown('id_kel_soal', $p_kel_soal, $d['id_kel_soal'], 'class="form-control" id="id_kel_soal" required'); ?></div>
            </div>
            <div class="form-group fgsoal">
              <div class="col-md-2"><label>Pengampu</label></div>
