      ...
      <div class="modal-body">
        ...
        <div id="petunjuk">
          <ul>
            ...
            <li><b>Waktu PM</b>, berlaku untuk 12.00 siang hingga 11.59 malam</li>
            <li><b>Waktu AM</b>, berlaku untuk jam 12.00 malam hingga 11.59 siang</li>
          </ul>
        </div>
      </div>
          ...
          <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
            ...
            <input type="hidden" name="jumlah_soal1" id="jumlah_soal1" value="0">
              <table class="table table-form">
                ...
                <tr><td>Kategori Soal</td><td><?php echo form_dropdown('mapel', $p_mapel, '', 'class="form-control"  id="mapel" required onchange="return __my_kel_soal(this.value)"'); ?></td></tr>
                <tr><td></td><td id="soalan"></td></tr>
                <!-- <tr>
                  <td>Kel 1</td>
                  <td>
                    <div style="
                          ...
                          gap: 10px;
                      ">
                      <input type="range" min="0" max="100" value="50" step="10" oninput="return slider_value(this)">
                      <input type="number" name="" style="width:50px">
                    </div>
                  </td>
                </tr> -->
                <tr><td>Jumlah Soal</td><td><?php echo form_input('jumlah_soal', '', 'class="form-control"  id="jumlah_soal" required readonly'); ?></td></tr>
