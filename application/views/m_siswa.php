  ...
  <div class="panel panel-info">
    <div class="panel-heading">Data Peserta
      <div class="tombol-kanan">
        ...
        <a class="btn btn-warning btn-sm tombol-kanan" href="<?php echo base_url(); ?>upload/format_import_peserta.xlsx" ><i class="glyphicon glyphicon-download"></i> &nbsp;&nbsp;Download Format Import</a>
          ...
          <form name="f_siswa" id="f_siswa" onsubmit="return m_siswa_s();">
            <input type="hidden" name="id" id="id" value="0">
              <table class="table table-form">
                ...
                <tr><td style="width: 25%">Kelompok</td><td style="width: 75%"><input type="text" class="form-control" name="jurusan" id="jurusan" required></td></tr>
                <tr><td style="width: 25%">Khusus</td><td style="width: 75%">
