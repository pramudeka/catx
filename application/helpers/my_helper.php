...
function gen_menu() {
	...
	if ($sess_level == "guru") {
	  $menu = array(
	            ...
	            array("icon"=>"calendar", "url"=>"m_ujian", "text"=>"Ujian"),
	            array("icon"=>"ok-sign", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else if ($sess_level == "siswa") {
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"pencil", "url"=>"ikuti_ujian", "text"=>"Ujian"),
	          );
	} else if ($sess_level == "admin") {
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"user", "url"=>"m_siswa", "text"=>"Data Peserta"),
	            array("icon"=>"briefcase", "url"=>"m_guru", "text"=>"Data Pengampu"),
	            array("icon"=>"tags", "url"=>"m_mapel", "text"=>"Kategori Soal"),
				array("icon"=>"bookmark", "url"=>"m_kel_soal", "text"=>"Kelompok Soal"),
	            //array("icon"=>"bookmark", "url"=>"m_kat", "text"=>"Kategori Ujian"),
	            array("icon"=>"list-alt", "url"=>"m_soal", "text"=>"Soal"),
	            array("icon"=>"ok-sign", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else {
